...
The Consortium Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/consortium-project/consortium/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Consortium Core project, and is not to be
confused with overall Consortium Network Protocol consensus changes.

Whether a pull request is merged into Consortium Core rests with the project merge
...
Patches that change Consortium consensus rules are considerably more involved than
...
Where a patchset proposes to change the Consortium consensus, it must have been
