...
from fake_stake.base_test import Consortium_FakeStakeTest

class zCSMValidCoinSpendTest(Consortium_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zCSMs..." % DENOM_TO_USE)
