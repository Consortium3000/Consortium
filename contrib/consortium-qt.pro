...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/consortium-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/consortium-cli.cpp \
           src/consortium-tx.cpp \
           src/consortium.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/consortium.qrc src/qt/consortium_locale.qrc

TRANSLATIONS += src/qt/locale/consortium_bg.ts \
                src/qt/locale/consortium_de.ts \
                src/qt/locale/consortium_en.ts \
                src/qt/locale/consortium_es.ts \
                src/qt/locale/consortium_fi.ts \
                src/qt/locale/consortium_fr.ts \
                src/qt/locale/consortium_it.ts \
                src/qt/locale/consortium_ja.ts \
                src/qt/locale/consortium_pl.ts \
                src/qt/locale/consortium_pt.ts \
                src/qt/locale/consortium_ru.ts \
                src/qt/locale/consortium_sk.ts \
                src/qt/locale/consortium_sv.ts \
                src/qt/locale/consortium_vi.ts \
                src/qt/locale/consortium_zh_CN.ts \
                src/qt/locale/consortium_zh_TW.ts
