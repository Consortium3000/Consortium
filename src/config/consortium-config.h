/* src/config/consortium-config.h.  Generated from consortium-config.h.in by configure.  */
/* src/config/consortium-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.consortium.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Consortium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Consortium Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "consortium"
