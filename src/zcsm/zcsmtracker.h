...
#ifndef Consortium_ZCSMTRACKER_H
#define Consortium_ZCSMTRACKER_H
...
public:
    CzCSMTracker(std::string strWalletFile);
    ~CzCSMTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCSMWallet* zCSMWallet = NULL);
...
#endif //Consortium_ZCSMTRACKER_H
