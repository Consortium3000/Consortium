...
#ifndef Consortium_ZCSMWALLET_H
#define Consortium_ZCSMWALLET_H
...
public:
    CzCSMWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCSM(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCSM(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
