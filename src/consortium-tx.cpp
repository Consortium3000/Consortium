...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Consortium Core consortium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  consortium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded consortium transaction") + "\n" +
                               "  consortium-tx [options] -create [commands]   " + _("Create hex-encoded consortium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded consortium transaction
