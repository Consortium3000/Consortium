                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCSMPathCustom = GetArg("-zcsmbackuppath", "");
    ...
    if(!strzCSMPathCustom.empty()) {
        ui->wallet_customzcsmbackuppath->setText(QString::fromStdString(strzCSMPathCustom));
        ui->wallet_customzcsmbackuppath_label->setVisible(true);
        ui->wallet_customzcsmbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCSMPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Consortium RPC console.") + "<br>" +
