...
/** Utility functions used by the Consortium Qt UI.
 */
namespace GUIUtil
{
...
// Render Consortium addresses in monospace font
...
// Parse "consortium:" URI into recipient object, return true on successful parsing
