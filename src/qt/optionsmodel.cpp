...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::CSM);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeConsortiumAmount"))
        SoftSetArg("-anonymizeconsortiumamount", settings.value("nAnonymizeConsortiumAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in consortium.cpp during shotdown to also remove the window positions
