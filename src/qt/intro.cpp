...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Consortium Core"),
     ...
     * override -datadir in the consortium.conf file in the default data directory
     * (to be consistent with consortiumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
