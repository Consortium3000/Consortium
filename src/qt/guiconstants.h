...
/* Consortium GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Consortium"
#define QAPP_ORG_DOMAIN "consortium.org"
#define QAPP_APP_NAME_DEFAULT "Consortium-Qt"
#define QAPP_APP_NAME_TESTNET "Consortium-Qt-testnet"
