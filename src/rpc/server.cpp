...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Consortium server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Consortium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Consortium features */
        {"consortium", "listmasternodes", &listmasternodes, true, true, false},
        {"consortium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"consortium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"consortium", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"consortium", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"consortium", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"consortium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"consortium", "masternodedebug", &masternodedebug, true, true, false},
        {"consortium", "startmasternode", &startmasternode, true, true, false},
        {"consortium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"consortium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"consortium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"consortium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"consortium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"consortium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"consortium", "preparebudget", &preparebudget, true, true, false},
        {"consortium", "submitbudget", &submitbudget, true, true, false},
        {"consortium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"consortium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"consortium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"consortium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"consortium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"consortium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"consortium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"consortium", "checkbudgets", &checkbudgets, true, true, false},
        {"consortium", "mnsync", &mnsync, true, true, false},
        {"consortium", "spork", &spork, true, true, false},
        {"consortium", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcsmseed", &getzcsmseed, false, false, true},
        {"zerocoin", "setzcsmseed", &setzcsmseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcsm", &searchdzcsm, false, false, true},
        {"zerocoin", "dzcsmstate", &dzcsmstate, false, false, true},
...
{
    return "> consortium-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13821/\n";
}
